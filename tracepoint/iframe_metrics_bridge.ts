...
export class TokenAnalysisIframe {
  ...
  private boundMessageHandler = (e: MessageEvent) => this.onMessage(e)
  ...
  private onMessage(event: MessageEvent): void {
    // Only accept messages from the expected origin unless targetOrigin is "*"
    ...
    // Handshake: child can request latest metrics
  ...
  private postMetrics(): void {
    ...
    win.postMessage(payload, this.getTargetOrigin())
    // Optionally keep a lightweight log line for debugging
